...
#
# [*hosts_domain*]
#   If provided, the OpenShift DNS instance will be configured to serve DNS requests for
#   the OpenShift host systems on a separate subdomain from the OpenShift-hosted applications.
#   Any hosts provided in the host_dns_list parameter will be pre-registered on this subdomain.
#   Default: unset
#
# [*hosts_bind_key*]
#   This value is ignored unless the hosts_domain parameter is set.
#   When the nameserver is remote, use this to specify the HMAC-MD5 key
#   for updates to the hosts dynamic zone. This is the "Key:" field from
#   the .private key file generated by dnssec-keygen. This field is
#   required on all nodes when hosts_domain is in use.
#
# [*host_dns_list*]
#   This value is ignored unless the hosts_domain parameter is set. It contains a comma-
#   delimited list of host entries in the form:
#
