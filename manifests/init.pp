...
#
# [*bind_keyname*]
#   When the nameserver is remote, use this to specify the HMAC-MD5 key name
#   for updates. This is the name of the key as defined in your named.conf file.
#   This field is required on all nodes. 
#
# [*bind_krb_keytab*]
